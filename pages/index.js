  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 sm:px-10 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  className="px-4 py-2 border-none rounded-md ml-8 cursor-pointer text-xxl text-white bg-teal-500 hover:bg-teal-600 hover:drop-shadow-xl active:bg-teal-800"
          ...
          <div className="text-center sm:p-10 py-10">
            ...
            <div className="mx-auto bg-gradient-to-b drop-shadow-lg from-teal-500 rounded-full w-80 h-80 relative overflow-hidden mt-5 mb-5 md:h-96 md:w-96">
        ...
        <section>
          <div>
            <h3 className="text-3xl py-1 dark:text-white ">My Skills & Proficiencies</h3>
