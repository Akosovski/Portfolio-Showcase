...
import image1 from '../assets/UMKMBookeeping-1.svg';
import image2 from '../assets/UMKMBookeeping-2.svg';
import image3 from '../assets/UMKMBookeeping-3.svg';
import image4 from '../assets/UMKMBookeeping-4.svg';
import image5 from '../assets/UMKMBookeeping-5.svg';
import image6 from '../assets/UMKMBookeeping-6.svg';
...
export default function Project1() {
  ...
  const modal_style = {
    ...
    const items = [
        {
            imageSource: image1,
            name: 'UMKMBookeeping-1'
        },
        {
            imageSource: image2,
            name: 'UMKMBookeeping-2'
        },
        {
            imageSource: image3,
            name: 'UMKMBookeeping-3'
        },
        {
            imageSource: image4,
            name: 'UMKMBookeeping-4'
        },
        {
            imageSource: image5,
            name: 'UMKMBookeeping-5'
        },
        {
            imageSource: image6,
            name: 'UMKMBookeeping-6'
        }
    ]
